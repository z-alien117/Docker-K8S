...
5. **Crear el Deployment y el service** 
...
7. **Revisa la aplicación ingresando a localhost y el puerto que este usa en este caso `80`**
...
<!-- 2. **Observación del Comportamiento del DaemonSet**
   - Agrega o elimina nodos del clúster si es posible y observa cómo el DaemonSet reacciona automáticamente, asegurando que cada nodo tenga una copia del pod. -->

<!-- #### Ejercicio:
Experimentar con diferentes configuraciones de DaemonSet y entender cómo afectan la distribución de los pods en los nodos. -->
